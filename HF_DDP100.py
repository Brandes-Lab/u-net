...
def main():
    ...
    args = {
        ...
        "gradient_accumulation_steps": 32,              # GA to reach bigger effective batch
        "base_dim": 512,                               # your model config param
        "growth": 128,                                  # your model config param
        "num_scales": 4,                               # your model config param
        "bf16": True,                                  # enable bfloat16
        "log_interval": 1000,                          # Trainer logging_steps
        "vep_interval": 10000,                         # VEP eval cadence
        "save_steps": 10000,                           # checkpoint cadence
    ...
    run_name = "unet_100M"                       # same run name you had
    if get_rank() == 0:
