...
def main():
    ...
    args = {
        ...
        "gradient_accumulation_steps": 64,              # GA to reach bigger effective batch
        "base_dim": 768,                               # your model config param
        "growth": 192,                                  # your model config param
        "num_scales": 4,                               # your model config param
        "bf16": True,                                  # enable bfloat16
        "log_interval": 100,                          # Trainer logging_steps
        "vep_interval": 2500,                         # VEP eval cadence
        "save_steps": 2500,                           # checkpoint cadence
    ...
    run_name = "unet_650M"                       # same run name you had
    if get_rank() == 0:
